...
use TotalFormVendors\Psr\Http\Message\ServerRequestInterface;
use TotalFormVendors\Psr\Http\Message\StreamInterface;
use TotalFormVendors\Psr\Http\Message\UploadedFileInterface;
use TotalFormVendors\Psr\Http\Message\UriInterface;
use RuntimeException;
use TotalFormVendors\TotalSuite\Foundation\Exceptions\InvalidMethodException;
use TotalFormVendors\TotalSuite\Foundation\Helpers\Concerns\ResolveFromContainer;
use TotalFormVendors\TotalSuite\Foundation\Http\Concerns\Shorthands;
...
class Request extends Message implements ServerRequestInterface
{
     ...
     * an instance of TotalFormVendors\Psr\Http\Message\UploadedFileInterface.
     *
