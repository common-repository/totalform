...
use TotalFormVendors\TotalSuite\Foundation\Contracts\Database\Connection as ConnectionInterface;
use TotalFormVendors\TotalSuite\Foundation\Database\Grammar\MySQL;
