...
namespace TotalFormVendors\TotalSuite\Foundation\Database;
! defined( 'ABSPATH' ) && exit();


use BadMethodCallException;
use TotalFormVendors\TotalSuite\Foundation\Database\Concerns\QueryHelpers;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\BaseQuery;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Delete;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Exists;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Expression;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Insert;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Pagination;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Select;
use TotalFormVendors\TotalSuite\Foundation\Database\Query\Update;
 ...
 * Class Table
 *
 * @package TotalFormVendors\TotalSuite\Foundation\Database
 */
class Query
{
    use QueryHelpers;
