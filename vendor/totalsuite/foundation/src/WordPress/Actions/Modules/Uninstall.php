...
use TotalFormVendors\TotalSuite\Foundation\WordPress\Tasks\Modules\UninstallModule;
...
class Uninstall extends Action
{
    ...
    {
        UninstallModule::invoke($this->manager, $moduleId);

        return ResponseFactory::json($moduleId);
    }
