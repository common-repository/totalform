...
namespace TotalFormVendors\Rakit\Validation;
! defined( 'ABSPATH' ) && exit();


use Closure;
use TotalFormVendors\Rakit\Validation\Rules\Interfaces\BeforeValidate;
use TotalFormVendors\Rakit\Validation\Rules\Interfaces\ModifyValue;
use TotalFormVendors\Rakit\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param \TotalFormVendors\Rakit\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|\TotalFormVendors\Rakit\Validation\Attribute
     */
     ...
     *
     * @return \TotalFormVendors\Rakit\Validation\ErrorBag
     */
     ...
     * Validate attribute
     *
     * @param \TotalFormVendors\Rakit\Validation\Attribute $attribute
     * @return void
     */
     ...
     * @param \TotalFormVendors\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \TotalFormVendors\Rakit\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param \TotalFormVendors\Rakit\Validation\Attribute $attribute
     * @param \TotalFormVendors\Rakit\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param \TotalFormVendors\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \TotalFormVendors\Rakit\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return \TotalFormVendors\Rakit\Validation\Validator
     */
