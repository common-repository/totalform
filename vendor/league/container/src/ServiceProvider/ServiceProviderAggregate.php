...
use Generator;
use TotalFormVendors\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use TotalFormVendors\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\TotalFormVendors\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
