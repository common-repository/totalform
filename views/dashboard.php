...
<totalform-root>
    <style>
        ...
        .totalform-loading-spinner:before {
            width: 50%;
            height: 50%;
            background: #cccccc;
        ...
        .totalform-loading-spinner:after {
            background: white;
            width: 75%;
            height: 75%;
            border-radius: 50%;
    ...
    <div class="totalform-loading">
        <div class="totalform-loading-spinner"></div>
    </div>
</totalform-root>
